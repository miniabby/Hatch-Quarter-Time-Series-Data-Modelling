...
```{r}
sig.x.train <- cbind(training.x$aus_beef.veal_slaughterings, training.x$aus_population_natural_increase, training.x$aus_beef.veal_exports, training.x$us_production_fedral_inspected_total.red.meat.and.poultry, training.x$aus_exports.of.beef..veal.and.live.cattle.to.US, training.x$us_livestock_commercial_mature.sheep, training.x$us_livestock_commercial_beef, training.x$us_veganism_trend_ratio, training.x$us_fed_avg_dressed_calves, training.x$us_veganism, training.c$ca_beef_export_total, training.c$ca_beef_veal_prod, training.c$ca_population_natural_increase, training.c$ca_total_cattle_calf, training.c$ca_dairy_cattle_calf, training.c$ca_beef_slaughter, training.c$ca_meat_prod, training.c$ca_avg_rainfall, training.c$ca_beef_export_us, training.c$nz_beef_export_total, training.c$nz_beef_veal_prod, training.c$nz_population_natural_increase, training.c$nz_total_cattle_calf, training.c$nz_dairy_cattle_calf, training.c$nz_beef_slaughter, training.c$nz_meat_prod, training.c$nz_avg_rainfall, training.c$nz_beef_export_us)
...
ARIMA.with.Seasonality.plot.12 <- ARIMA.with.Seasonality.plot.12 + labs(title = "ARIMA.with.Seasonality.12") + labs(caption = "RMSE = 0.03425112, MAE = 0.02875957, MAPE = 11.44694")
...
ARIMA.Corr.with.Seasonality.forecast.12 <- ARIMA.Corr.with.Seasonality.forecast.12 + labs(title = "ARIMA.Corr.with.Seasonality.forecast.12") + labs(caption = "RMSE = 0.03425112, MAE = 0.02875957, MAPE = 11.44694")
